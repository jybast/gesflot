 ...
 */
final class Version20220215170702 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entretenir ADD fournisseur_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE entretenir ADD CONSTRAINT FK_3E65A1F670C757F FOREIGN KEY (fournisseur_id) REFERENCES fournisseur (id)');
        $this->addSql('CREATE INDEX IDX_3E65A1F670C757F ON entretenir (fournisseur_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entretenir DROP FOREIGN KEY FK_3E65A1F670C757F');
        $this->addSql('DROP INDEX IDX_3E65A1F670C757F ON entretenir');
        $this->addSql('ALTER TABLE entretenir DROP fournisseur_id');
