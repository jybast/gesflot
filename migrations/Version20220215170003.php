 ...
 */
final class Version20220215170003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_AC721A77153098 ON type_carburant (code)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_76BCCF0CFF7747B4 ON type_charge (titre)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9F9E97CAFF7747B4 ON type_entretien (titre)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_AC721A77153098 ON type_carburant');
        ...
        $this->addSql('DROP INDEX UNIQ_76BCCF0CFF7747B4 ON type_charge');
        $this->addSql('ALTER TABLE type_charge CHANGE titre titre VARCHAR(150) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('DROP INDEX UNIQ_9F9E97CAFF7747B4 ON type_entretien');
