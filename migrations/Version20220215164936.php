 ...
 */
final class Version20220215164936 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE conduire ADD compteur INT NOT NULL');
        $this->addSql('ALTER TABLE ravitailler ADD trajet_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE ravitailler ADD CONSTRAINT FK_66E0FCA9D12A823 FOREIGN KEY (trajet_id) REFERENCES conduire (id)');
        $this->addSql('CREATE INDEX IDX_66E0FCA9D12A823 ON ravitailler (trajet_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE conduire DROP compteur, CHANGE partir partir VARCHAR(150) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE arriver arriver VARCHAR(150) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE ravitailler DROP FOREIGN KEY FK_66E0FCA9D12A823');
        $this->addSql('DROP INDEX IDX_66E0FCA9D12A823 ON ravitailler');
        $this->addSql('ALTER TABLE ravitailler DROP trajet_id');
