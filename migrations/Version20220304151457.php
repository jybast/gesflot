 ...
 */
final class Version20220304151457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE charge ADD trajet_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE charge ADD CONSTRAINT FK_556BA434D12A823 FOREIGN KEY (trajet_id) REFERENCES conduire (id)');
        $this->addSql('CREATE INDEX IDX_556BA434D12A823 ON charge (trajet_id)');
        $this->addSql('ALTER TABLE conduire ADD commentaire LONGTEXT DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE charge DROP FOREIGN KEY FK_556BA434D12A823');
        $this->addSql('DROP INDEX IDX_556BA434D12A823 ON charge');
        $this->addSql('ALTER TABLE charge DROP trajet_id, CHANGE titre titre VARCHAR(150) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE conduire DROP commentaire, CHANGE partir partir VARCHAR(150) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE arriver arriver VARCHAR(150) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
