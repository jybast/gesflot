 ...
 */
final class Version20220215164359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entretenir (id INT AUTO_INCREMENT NOT NULL, vehicule_id INT DEFAULT NULL, maintenir_id INT DEFAULT NULL, INDEX IDX_3E65A1F4A4A3511 (vehicule_id), INDEX IDX_3E65A1FEA5F64F6 (maintenir_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE entretenir ADD CONSTRAINT FK_3E65A1F4A4A3511 FOREIGN KEY (vehicule_id) REFERENCES vehicule (id)');
        $this->addSql('ALTER TABLE entretenir ADD CONSTRAINT FK_3E65A1FEA5F64F6 FOREIGN KEY (maintenir_id) REFERENCES entretien (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE entretenir');
        $this->addSql('ALTER TABLE charge CHANGE titre titre VARCHAR(150) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE conduire CHANGE partir partir VARCHAR(150) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE arriver arriver VARCHAR(150) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE type_carburant CHANGE code code VARCHAR(5) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE titre titre VARCHAR(20) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE nom nom VARCHAR(20) NOT NULL COLLATE `utf8mb4_unicode_ci`');
