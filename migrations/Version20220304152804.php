 ...
 */
final class Version20220304152804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE type_entretien ADD code VARCHAR(20) NOT NULL, ADD couleur VARCHAR(10) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE type_entretien DROP code, DROP couleur, CHANGE titre titre VARCHAR(150) NOT NULL COLLATE `utf8mb4_unicode_ci`');
