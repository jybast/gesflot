 ...
 */
final class Version20220304151615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE type_carburant ADD couleur VARCHAR(10) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE type_carburant DROP couleur, CHANGE code code VARCHAR(5) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE titre titre VARCHAR(20) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE nom nom VARCHAR(20) NOT NULL COLLATE `utf8mb4_unicode_ci`');
