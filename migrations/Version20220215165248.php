 ...
 */
final class Version20220215165248 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ravitailler ADD type_carburant_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE ravitailler ADD CONSTRAINT FK_66E0FCA9B5991721 FOREIGN KEY (type_carburant_id) REFERENCES type_carburant (id)');
        $this->addSql('CREATE INDEX IDX_66E0FCA9B5991721 ON ravitailler (type_carburant_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ravitailler DROP FOREIGN KEY FK_66E0FCA9B5991721');
        $this->addSql('DROP INDEX IDX_66E0FCA9B5991721 ON ravitailler');
        $this->addSql('ALTER TABLE ravitailler DROP type_carburant_id');
